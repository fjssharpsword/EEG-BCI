...
if __name__ == "__main__":
    #Du, Xiaobing, et al. "An efficient LSTM network for emotion recognition from multichannel EEG signals." 
    # IEEE Transactions on Affective Computing 13.3 (2020): 1528-1540.

...
if __name__ == "__main__":
    #Song T, Zheng W, Song P, et al. EEG emotion recognition using dynamical graph convolutional neural networks[J]. 
    # IEEE Transactions on Affective Computing, 2018, 11(3): 532-541.
    ...
    model = EEGDGCNN(in_channels = 18, num_electrodes = 512, num_classes=2).to(device) #graph on chunk data
    out = model(x)
    print(out.shape)